...
def home(file) :
    ...
    predictions = probability_model.predict(dir)
    result = np.argmax(predictions[3])
    # if result == 0:
    #     prediction = 'T-shirt'
    # elif result == 1:
    #     prediction = 'Trouser'
    ...
    name1 = "shoes"
    my_url1 = "https://www.ebay.com/sch/i.html?_from=R40&_trksid=m570.l1313&_nkw=" + name + "&_sacat=0"
    ...
    context = {'name1': names[0],'name2': names[1],'name3': names[2],'name4': names[3], 'price1': price[0],'link1':list1[0],
               ...
               'link8':links[3],'result':test_image.shape}
    return context